...
# G130M_N_filename = "/Users/efrazer/leadingarm/sightlines/NGC3125/NGC3125-G130M-N"
...
# SiII
# dataset.add_component("SiII",  0., 150.0, 14.32, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  220, 75.0, 13.32, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 150.0, 14.23, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 220, 75.0, 13.23, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 150.0, 14.34, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  220, 75.0, 13.34, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  150.0, 15.43, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   220, 75.0, 14.43, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 150.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   220, 75.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="NGC3125-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("NGC3125-XXX.fit")
dataset.save_cont_parameters_to_file("NGC3125-XXX.cont")
dataset.save_fit_regions("NGC3125-XXX.reg")
