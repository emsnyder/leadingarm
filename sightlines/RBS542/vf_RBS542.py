...
# SiII
# dataset.add_component("SiII",  0., 200.0, 14.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  300, 100.0, 13.29, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 200.0, 14.46, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 300, 100.0, 13.46, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 200.0, 13.97, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  300, 100.0, 12.97, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  200.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   300, 100.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 200.0, 14.53, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   300, 100.0, 13.53, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS542-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS542-XXX.fit")
dataset.save_cont_parameters_to_file("RBS542-XXX.cont")
dataset.save_fit_regions("RBS542-XXX.reg")
