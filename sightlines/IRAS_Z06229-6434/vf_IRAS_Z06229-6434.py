...
dataset.set_name("IRAS_Z06229-6434-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/IRAS_Z06229-6434/IRAS_Z06229-6434-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/IRAS_Z06229-6434/IRAS_Z06229-6434-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 280.0, 15.28, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  350, 140.0, 14.28, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 280.0, 14.92, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 350, 140.0, 13.92, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 280.0, 14.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  350, 140.0, 13.29, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  280.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   350, 140.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 280.0, 14.36, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   350, 140.0, 13.36, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="IRAS_Z06229-6434-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("IRAS_Z06229-6434-XXX.fit")
dataset.save_cont_parameters_to_file("IRAS_Z06229-6434-XXX.cont")
dataset.save_fit_regions("IRAS_Z06229-6434-XXX.reg")
