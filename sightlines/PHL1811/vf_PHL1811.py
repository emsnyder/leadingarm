...
# SiII
# dataset.add_component("SiII",  0., 260.0, 14.37, var_z=1, var_b=1, var_N=1)
...
# CII
# dataset.add_component("CII",   0,  260.0, 15.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -200, 130.0, 14.29, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PHL1811-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PHL1811-XXX.fit")
dataset.save_cont_parameters_to_file("PHL1811-XXX.cont")
dataset.save_fit_regions("PHL1811-XXX.reg")
