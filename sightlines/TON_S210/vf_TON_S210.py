...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/TON_S210/TON_S210-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/TON_S210/TON_S210-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 140.0, 14.47, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -200, 70.0, 13.47, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 140.0, 14.4, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -200, 70.0, 13.4, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 140.0, 14.02, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -200, 70.0, 13.02, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  140.0, 15.28, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -200, 70.0, 14.28, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 140.0, 14.79, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -200, 70.0, 13.79, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="TON_S210-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("TON_S210-XXX.fit")
dataset.save_cont_parameters_to_file("TON_S210-XXX.cont")
dataset.save_fit_regions("TON_S210-XXX.reg")
