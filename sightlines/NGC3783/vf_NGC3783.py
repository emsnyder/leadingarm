...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/NGC3783/NGC3783-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/NGC3783/NGC3783-G130M"
...
# G130M_N_filename = "/Users/efrazer/leadingarm/sightlines/NGC3783/NGC3783-G130M-N"
...
# SiII
# dataset.add_component("SiII",  0., 150.0, 14.86, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  240, 75.0, 13.86, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 150.0, 14.02, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 240, 75.0, 13.02, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 150.0, 13.86, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  240, 75.0, 12.86, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  150.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   240, 75.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 150.0, 14.24, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   240, 75.0, 13.24, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="NGC3783-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("NGC3783-XXX.fit")
dataset.save_cont_parameters_to_file("NGC3783-XXX.cont")
dataset.save_fit_regions("NGC3783-XXX.reg")
