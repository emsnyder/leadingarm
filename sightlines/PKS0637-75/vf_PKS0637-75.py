...
dataset.set_name("PKS0637-75-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0637-75/PKS0637-75-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0637-75/PKS0637-75-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 220.0, 15.24, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  240, 110.0, 14.24, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 220.0, 14.82, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 240, 110.0, 13.82, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 220.0, 14.31, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  240, 110.0, 13.31, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  220.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   240, 110.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 220.0, 14.84, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   240, 110.0, 13.84, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS0637-75-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS0637-75-XXX.fit")
dataset.save_cont_parameters_to_file("PKS0637-75-XXX.cont")
dataset.save_fit_regions("PKS0637-75-XXX.reg")
