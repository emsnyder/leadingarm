...
dataset.set_name("ESO031-G08-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/ESO031-G08/ESO031-G08-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/ESO031-G08/ESO031-G08-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 190.0, 15.63, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  207, 95.0, 14.63, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 190.0, 14.87, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 207, 95.0, 13.87, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 190.0, 14.47, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  207, 95.0, 13.47, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  190.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   207, 95.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 190.0, 14.89, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   207, 95.0, 13.89, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="ESO031-G08-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("ESO031-G08-XXX.fit")
dataset.save_cont_parameters_to_file("ESO031-G08-XXX.cont")
dataset.save_fit_regions("ESO031-G08-XXX.reg")
