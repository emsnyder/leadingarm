...
dataset.set_name("QSO1220-2859-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/QSO1220-2859/QSO1220-2859-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/QSO1220-2859/QSO1220-2859-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 150.0, 14.46, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -180, 75.0, 13.46, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 150.0, 14.32, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -180, 75.0, 13.32, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 150.0, 14.08, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -180, 75.0, 13.08, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  150.0, 15.39, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -180, 75.0, 14.39, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 150.0, 14.66, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -180, 75.0, 13.66, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="QSO1220-2859-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("QSO1220-2859-XXX.fit")
dataset.save_cont_parameters_to_file("QSO1220-2859-XXX.cont")
dataset.save_fit_regions("QSO1220-2859-XXX.reg")
