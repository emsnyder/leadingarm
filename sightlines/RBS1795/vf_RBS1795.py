...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/RBS1795/RBS1795-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/RBS1795/RBS1795-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 13.5, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  150.0, 50.0, 12.5, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.51, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 150.0, 50.0, 12.51, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 13.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  150.0, 50.0, 12.6, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 14.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   150.0, 50.0, 13.29, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, 14.49, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   150.0, 50.0, 13.49, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS1795-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS1795-XXX.fit")
dataset.save_cont_parameters_to_file("RBS1795-XXX.cont")
dataset.save_fit_regions("RBS1795-XXX.reg")
