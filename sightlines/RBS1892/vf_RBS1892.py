...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/RBS1892/RBS1892-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/RBS1892/RBS1892-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 80.0, 13.53, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  200.0, 40.0, 12.53, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 80.0, 13.37, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 200.0, 40.0, 12.37, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 80.0, 13.8, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  200.0, 40.0, 12.8, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  80.0, 14.57, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   200.0, 40.0, 13.57, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 80.0, 14.26, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   200.0, 40.0, 13.26, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS1892-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS1892-XXX.fit")
dataset.save_cont_parameters_to_file("RBS1892-XXX.cont")
dataset.save_fit_regions("RBS1892-XXX.reg")
