...
# SiIII
# dataset.add_component("SiIII", 0., 200.0, 13.83, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -340, 100.0, 12.83, var_z=1, var_b=1, var_N=1)
...
# CII
# dataset.add_component("CII",   0,  200.0, 14.42, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -340, 100.0, 13.42, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 200.0, 14.62, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -340, 100.0, 13.62, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="MRK335-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MRK335-XXX.fit")
dataset.save_cont_parameters_to_file("MRK335-XXX.cont")
dataset.save_fit_regions("MRK335-XXX.reg")
