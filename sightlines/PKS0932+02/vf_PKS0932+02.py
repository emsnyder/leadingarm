...
dataset.set_name("PKS0932+02-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0932+02/PKS0932+02-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0932+02/PKS0932+02-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 14.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  250.0, 50.0, 13.6, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 14.08, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 250.0, 50.0, 13.08, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 14.43, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  250.0, 50.0, 13.43, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 15.21, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   250.0, 50.0, 14.21, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, 14.91, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   250.0, 50.0, 13.91, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS0932+02-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS0932+02-XXX.fit")
dataset.save_cont_parameters_to_file("PKS0932+02-XXX.cont")
dataset.save_fit_regions("PKS0932+02-XXX.reg")
