...
dataset.set_name("HE1003+0149-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HE1003+0149/HE1003+0149-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE1003+0149/HE1003+0149-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 14.17, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  250.0, 50.0, 13.17, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.87, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 250.0, 50.0, 12.87, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 13.92, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  250.0, 50.0, 12.92, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 14.88, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   250.0, 50.0, 13.88, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, 14.31, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   250.0, 50.0, 13.31, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE1003+0149-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE1003+0149-XXX.fit")
dataset.save_cont_parameters_to_file("HE1003+0149-XXX.cont")
dataset.save_fit_regions("HE1003+0149-XXX.reg")
