...
dataset.set_name("PKS0439-433-XXX")
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0439-433/PKS0439-433-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 140.0, 15.06, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  240, 70.0, 14.06, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 140.0, 14.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 240, 70.0, 13.29, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 140.0, 14.16, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  240, 70.0, 13.16, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  140.0, 14.98, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   240, 70.0, 13.98, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 140.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   240, 70.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS0439-433-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS0439-433-XXX.fit")
dataset.save_cont_parameters_to_file("PKS0439-433-XXX.cont")
dataset.save_fit_regions("PKS0439-433-XXX.reg")
