...
# SiII
# dataset.add_component("SiII",  0., 50.0, 15.18, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  120.0, 35.0, 15.18, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  175.0, 20.0, 14.18, var_z=1, var_b=1, var_N=1)
