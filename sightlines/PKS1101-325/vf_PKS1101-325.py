...
dataset.set_name("PKS1101-325-XXX")
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS1101-325/PKS1101-325-G130M"
...
# G130M_N_filename = "/Users/efrazer/leadingarm/sightlines/PKS1101-325/PKS1101-325-G130M-N"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 14.18, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  270.0, 50.0, 13.18, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.76, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 270.0, 50.0, 12.76, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 13.81, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  270.0, 50.0, 12.81, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 15.2, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   270.0, 50.0, 14.2, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   270.0, 50.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS1101-325-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS1101-325-XXX.fit")
dataset.save_cont_parameters_to_file("PKS1101-325-XXX.cont")
dataset.save_fit_regions("PKS1101-325-XXX.reg")
