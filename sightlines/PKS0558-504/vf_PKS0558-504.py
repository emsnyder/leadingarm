...
dataset.set_name("PKS0558-504-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0558-504/PKS0558-504-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0558-504/PKS0558-504-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 130.0, 13.82, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  265, 65.0, 12.82, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 130.0, 13.68, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 265, 65.0, 12.68, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 130.0, 14.23, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  265, 65.0, 13.23, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  130.0, 15.06, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   265, 65.0, 14.06, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 130.0, 14.24, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   265, 65.0, 13.24, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS0558-504-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS0558-504-XXX.fit")
dataset.save_cont_parameters_to_file("PKS0558-504-XXX.cont")
dataset.save_fit_regions("PKS0558-504-XXX.reg")
