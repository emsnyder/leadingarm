...
dataset.set_name("HS0033+4300-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HS0033+4300/HS0033+4300-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HS0033+4300/HS0033+4300-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 14.68, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -350.0, 50.0, 13.68, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.48, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -350.0, 50.0, 12.48, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -350.0, 50.0, -999.0, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 14.49, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -350.0, 50.0, 13.49, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -350.0, 50.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HS0033+4300-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HS0033+4300-XXX.fit")
dataset.save_cont_parameters_to_file("HS0033+4300-XXX.cont")
dataset.save_fit_regions("HS0033+4300-XXX.reg")
