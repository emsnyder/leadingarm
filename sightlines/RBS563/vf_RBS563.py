...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/RBS563/RBS563-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/RBS563/RBS563-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 220.0, 15.53, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  220, 110.0, 14.53, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 220.0, 15.08, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 220, 110.0, 14.08, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 220.0, 14.85, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  220, 110.0, 13.85, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  220.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   220, 110.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 220.0, 5.36, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   220, 110.0, 4.36, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS563-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS563-XXX.fit")
dataset.save_cont_parameters_to_file("RBS563-XXX.cont")
dataset.save_fit_regions("RBS563-XXX.reg")
