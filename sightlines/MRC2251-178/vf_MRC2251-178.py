...
dataset.set_name("MRC2251-178-XXX")
...
dataset.plot_fit(filename="MRC2251-178-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MRC2251-178-XXX.fit")
dataset.save_cont_parameters_to_file("MRC2251-178-XXX.cont")
dataset.save_fit_regions("MRC2251-178-XXX.reg")
