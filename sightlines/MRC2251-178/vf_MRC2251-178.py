...
dataset.set_name("MRC2251-178-SiIII")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/MRC2251-178/MRC2251-178-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/MRC2251-178/MRC2251-178-G130M"
...
# dataset.add_component_velocity("SiII",  -260, 75.0, 12.96, var_z=1, var_b=1, var_N=1)

# SiIII
dataset.add_component("SiIII", 0., 150.0, 13.99, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("SiIII", -260, 75.0, 12.99, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 150.0, 14.04, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -260, 75.0, 13.04, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  150.0, 14.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -260, 75.0, 13.29, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 150.0, 14.71, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -260, 75.0, 13.71, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="MRC2251-178-SiIII.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MRC2251-178-SiIII.fit")
dataset.save_cont_parameters_to_file("MRC2251-178-SiIII.cont")
dataset.save_fit_regions("MRC2251-178-SiIII.reg")
