...
dataset.set_name("HE0238-1904-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HE0238-1904/HE0238-1904-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE0238-1904/HE0238-1904-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 13.7, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -210.0, 50.0, 12.7, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.28, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -210.0, 50.0, 12.28, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 13.91, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -210.0, 50.0, 12.91, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 14.24, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -210.0, 50.0, 13.24, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, 14.09, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -210.0, 50.0, 13.09, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0238-1904-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0238-1904-XXX.fit")
dataset.save_cont_parameters_to_file("HE0238-1904-XXX.cont")
dataset.save_fit_regions("HE0238-1904-XXX.reg")
