...
dataset.set_name("MS0117.2-2837-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/MS0117.2-2837/MS0117.2-2837-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/MS0117.2-2837/MS0117.2-2837-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 175.0, 14.21, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -120, 87.5, 13.21, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 175.0, 14.39, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -120, 87.5, 13.39, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 175.0, 14.05, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -120, 87.5, 13.05, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  175.0, 15.11, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -120, 87.5, 14.11, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 175.0, 14.71, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -120, 87.5, 13.71, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="MS0117.2-2837-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MS0117.2-2837-XXX.fit")
dataset.save_cont_parameters_to_file("MS0117.2-2837-XXX.cont")
dataset.save_fit_regions("MS0117.2-2837-XXX.reg")
