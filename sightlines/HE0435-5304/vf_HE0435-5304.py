...
dataset.set_name("HE0435-5304-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HE0435-5304/HE0435-5304-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE0435-5304/HE0435-5304-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 180.0, 14.79, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  280, 90.0, 13.79, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 180.0, 14.67, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 280, 90.0, 13.67, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 180.0, 14.22, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  280, 90.0, 13.22, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  180.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   280, 90.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 180.0, 14.62, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   280, 90.0, 13.62, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0435-5304-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0435-5304-XXX.fit")
dataset.save_cont_parameters_to_file("HE0435-5304-XXX.cont")
dataset.save_fit_regions("HE0435-5304-XXX.reg")
