...
dataset.set_name("PKS0552-640-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0552-640/PKS0552-640-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0552-640/PKS0552-640-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 250.0, 14.98, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  279, 125.0, 13.98, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 250.0, 14.86, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 279, 125.0, 13.86, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 250.0, 14.1, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  279, 125.0, 13.1, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  250.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   279, 125.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 250.0, 14.83, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   279, 125.0, 13.83, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS0552-640-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS0552-640-XXX.fit")
dataset.save_cont_parameters_to_file("PKS0552-640-XXX.cont")
dataset.save_fit_regions("PKS0552-640-XXX.reg")
