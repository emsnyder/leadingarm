...
# SiII
# dataset.add_component("SiII",  0., 100.0, 13.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  135, 50.0, 12.6, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.57, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 135, 50.0, 12.57, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS1897-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS1897-XXX.fit")
dataset.save_cont_parameters_to_file("RBS1897-XXX.cont")
dataset.save_fit_regions("RBS1897-XXX.reg")
