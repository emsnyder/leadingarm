...
dataset.set_name("LBQS1019+0147-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/LBQS1019+0147/LBQS1019+0147-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/LBQS1019+0147/LBQS1019+0147-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 14.38, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  230.0, 50.0, 13.38, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.85, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 230.0, 50.0, 12.85, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 14.15, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  230.0, 50.0, 13.15, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 15.17, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   230.0, 50.0, 14.17, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, 14.72, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   230.0, 50.0, 13.72, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="LBQS1019+0147-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("LBQS1019+0147-XXX.fit")
dataset.save_cont_parameters_to_file("LBQS1019+0147-XXX.cont")
dataset.save_fit_regions("LBQS1019+0147-XXX.reg")
