...
dataset.set_name("ESO265-G23-XXX")
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/ESO265-G23/ESO265-G23-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 140.0, 14.72, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  230, 70.0, 13.72, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 140.0, 14.35, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 230, 70.0, 13.35, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("CIV",   230, 70.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="ESO265-G23-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("ESO265-G23-XXX.fit")
dataset.save_cont_parameters_to_file("ESO265-G23-XXX.cont")
dataset.save_fit_regions("ESO265-G23-XXX.reg")
