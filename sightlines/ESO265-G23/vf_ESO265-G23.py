...
# SiII
# dataset.add_component("SiII",  0., 50.0, 14.72, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  150, 40.0, 13.72, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  187, 30.0, 13.72, var_z=1, var_b=1, var_N=1)
