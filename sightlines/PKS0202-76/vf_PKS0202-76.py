...
dataset.set_name("PKS0202-76-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0202-76/PKS0202-76-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PKS0202-76/PKS0202-76-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 260.0, 15.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  150, 130.0, 14.6, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 260.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 150, 130.0, -999.0, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 260.0, 14.18, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  150, 130.0, 13.18, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  260.0, 16.23, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   150, 130.0, 15.23, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 260.0, 14.7, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   150, 130.0, 13.7, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PKS0202-76-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PKS0202-76-XXX.fit")
dataset.save_cont_parameters_to_file("PKS0202-76-XXX.cont")
dataset.save_fit_regions("PKS0202-76-XXX.reg")
