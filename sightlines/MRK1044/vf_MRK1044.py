...
# CII
dataset.add_component("CII",   0,  50.0, 15.0, var_z=1, var_b=1, var_N=1)
...
dataset.add_component_velocity("CII",   -210, 30.0, 13.58, var_z=1, var_b=1, var_N=1)
...
# dataset.plot_fit(filename="MRK1044-CII.pdf")


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MRK1044-CII.fit")
dataset.save_cont_parameters_to_file("MRK1044-CII.cont")
dataset.save_fit_regions("MRK1044-CII.reg")
