...
dataset.set_name("RX_J0503.1-6634-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/RX_J0503.1-6634/RX_J0503.1-6634-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/RX_J0503.1-6634/RX_J0503.1-6634-G130M"
...
# log N(Si II) is a lower limit. Line is saturated.
...
# SiII
# dataset.add_component("SiII",  0., 215.0, 15.82, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  285, 107.5, 14.82, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 215.0, 15.14, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 285, 107.5, 14.14, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 215.0, 14.38, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  285, 107.5, 13.38, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  215.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   285, 107.5, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 215.0, 14.67, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   285, 107.5, 13.67, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RX_J0503.1-6634-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RX_J0503.1-6634-XXX.fit")
dataset.save_cont_parameters_to_file("RX_J0503.1-6634-XXX.cont")
dataset.save_fit_regions("RX_J0503.1-6634-XXX.reg")
