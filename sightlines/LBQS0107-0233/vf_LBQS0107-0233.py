...
dataset.set_name("LBQS0107-0233-SiII")
...
# SiII
dataset.add_component("SiII",  0., 50.0, 14.33, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("SiII",  -260, 5.0, 11.7, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("CIV",   -175, 55.0, 13.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -260, 55.0, 13.29, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -350, 55.0, 13.29, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="LBQS0107-0233-SiII.pdf")


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("LBQS0107-0233-SiII.fit")
dataset.save_cont_parameters_to_file("LBQS0107-0233-SiII.cont")
dataset.save_fit_regions("LBQS0107-0233-SiII.reg")
