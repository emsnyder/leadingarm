...
dataset.set_name("LBQS0107-0233-CIV")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/LBQS0107-0233/LBQS0107-0233-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/LBQS0107-0233/LBQS0107-0233-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 40.0, 14.2, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -90, 20.0, 13.5, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -260, 10.0, 12.3, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 50.0, 13.7, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -180, 20.0, 12.7, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -260, 20.0, 12.7, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 110.0, 14.11, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -260, 55.0, 13.11, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  110.0, 14.59, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -260, 55.0, 13.59, var_z=1, var_b=1, var_N=1)

# CIV
dataset.add_component("CIV",   0., 110.0, 14.29, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -50, 55.0, 13.5, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -120, 15.0, 13.1, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -175, 30.0, 13.29, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -260, 30.0, 13.29, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -350, 30.0, 13.29, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -380, 15.0, 13.1, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="LBQS0107-0233-CIV.pdf")


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("LBQS0107-0233-CIV.fit")
dataset.save_cont_parameters_to_file("LBQS0107-0233-CIV.cont")
dataset.save_fit_regions("LBQS0107-0233-CIV.reg")
