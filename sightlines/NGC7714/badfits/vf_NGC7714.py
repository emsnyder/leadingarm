...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/NGC7714/NGC7714-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/NGC7714/NGC7714-G130M"
...
# dataset.add_component_velocity("SiIII", -320, 115.0, 13.69, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 230.0, 14.51, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="NGC7714-CII.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("NGC7714-CII.fit")
dataset.save_cont_parameters_to_file("NGC7714-CII.cont")
dataset.save_fit_regions("NGC7714-CII.reg")
