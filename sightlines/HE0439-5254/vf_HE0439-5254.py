...
dataset.set_name("HE0439-5254-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HE0439-5254/HE0439-5254-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE0439-5254/HE0439-5254-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 150.0, 14.62, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  280, 75.0, 13.62, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 150.0, 14.36, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 280, 75.0, 13.36, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 150.0, 14.77, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  280, 75.0, 13.77, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  150.0, 15.27, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   280, 75.0, 14.27, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 150.0, 14.57, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   280, 75.0, 13.57, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0439-5254-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0439-5254-XXX.fit")
dataset.save_cont_parameters_to_file("HE0439-5254-XXX.cont")
dataset.save_fit_regions("HE0439-5254-XXX.reg")
