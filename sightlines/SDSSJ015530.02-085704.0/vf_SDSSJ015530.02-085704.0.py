...
dataset.set_name("SDSSJ015530.02-085704.0-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/SDSSJ015530.02-085704.0/SDSSJ015530.02-085704.0-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/SDSSJ015530.02-085704.0/SDSSJ015530.02-085704.0-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 80.0, 14.44, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -140, 40.0, 13.44, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("CII",   -140, 40.0, 14.13, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 80.0, 14.61, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -140, 40.0, 13.61, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="SDSSJ015530.02-085704.0-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("SDSSJ015530.02-085704.0-XXX.fit")
dataset.save_cont_parameters_to_file("SDSSJ015530.02-085704.0-XXX.cont")
dataset.save_fit_regions("SDSSJ015530.02-085704.0-XXX.reg")
