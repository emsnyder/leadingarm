...
dataset.set_name("HE0429-5343-XXX")
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE0429-5343/HE0429-5343-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 105.0, 14.42, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  275, 52.5, 13.42, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 105.0, 14.24, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 275, 52.5, 13.24, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 105.0, 14.34, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  275, 52.5, 13.34, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  105.0, 15.25, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   275, 52.5, 14.25, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 105.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   275, 52.5, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0429-5343-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0429-5343-XXX.fit")
dataset.save_cont_parameters_to_file("HE0429-5343-XXX.cont")
dataset.save_fit_regions("HE0429-5343-XXX.reg")
