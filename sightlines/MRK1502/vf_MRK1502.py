...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/MRK1502/MRK1502-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 190.0, 14.3, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -245.0, 95.0, 13.3, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 190.0, 14.02, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -245.0, 95.0, 13.02, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 190.0, 14.36, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -245.0, 95.0, 13.36, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  190.0, 14.85, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -245.0, 95.0, 13.85, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 190.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -245.0, 95.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="MRK1502-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MRK1502-XXX.fit")
dataset.save_cont_parameters_to_file("MRK1502-XXX.cont")
dataset.save_fit_regions("MRK1502-XXX.reg")
