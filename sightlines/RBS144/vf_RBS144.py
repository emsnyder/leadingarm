...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/RBS144/RBS144-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/RBS144/RBS144-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 50.0, 13.86, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  92, 32.5, 13.2, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  180, 32.5, 13.2, var_z=1, var_b=1, var_N=1)


# SiIII
dataset.add_component("SiIII", 0., 50.0, 13.56, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("SiIII", 92, 32.5, 13., var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("SiIII", 180, 32.5, 13., var_z=1, var_b=1, var_N=1)


# CII
# dataset.add_component("CII",   0,  50.0, 14.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   92, 30.5, 13.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   180, 30, 13.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   250, 30, 13.6, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS144-SiIII.pdf")


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS144-SiIII.fit")
dataset.save_cont_parameters_to_file("RBS144-SiIII.cont")
dataset.save_fit_regions("RBS144-SiIII.reg")
