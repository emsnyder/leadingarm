...
# SiII
# dataset.add_component("SiII",  0., 145.0, 14.86, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  92, 72.5, 13.86, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 145.0, 14.56, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 92, 72.5, 13.56, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 145.0, 14.1, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  92, 72.5, 13.1, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  145.0, 15.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   92, 72.5, 14.6, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 145.0, 14.51, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   92, 72.5, 13.51, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS144-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS144-XXX.fit")
dataset.save_cont_parameters_to_file("RBS144-XXX.cont")
dataset.save_fit_regions("RBS144-XXX.reg")
