...
dataset.set_name("IRAS01003-2238-XXX")
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/IRAS01003-2238/IRAS01003-2238-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 120.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -220.0, 60.0, -999.0, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 120.0, 14.01, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -220.0, 60.0, 13.01, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 120.0, 14.53, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -220.0, 60.0, 13.53, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  120.0, 15.18, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -220.0, 60.0, 14.18, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 120.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -220.0, 60.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="IRAS01003-2238-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("IRAS01003-2238-XXX.fit")
dataset.save_cont_parameters_to_file("IRAS01003-2238-XXX.cont")
dataset.save_fit_regions("IRAS01003-2238-XXX.reg")
