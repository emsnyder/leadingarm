...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/RBS567/RBS567-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/RBS567/RBS567-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 180.0, 14.17, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  220, 90.0, 13.17, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 180.0, 14.38, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 220, 90.0, 13.38, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 180.0, 14.13, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  220, 90.0, 13.13, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  180.0, 15.26, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   220, 90.0, 14.26, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 180.0, 14.56, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   220, 90.0, 13.56, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="RBS567-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("RBS567-XXX.fit")
dataset.save_cont_parameters_to_file("RBS567-XXX.cont")
dataset.save_fit_regions("RBS567-XXX.reg")
