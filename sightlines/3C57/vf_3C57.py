...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/3C57/3C57-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/3C57/3C57-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 100.0, 13.97, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -210.0, 50.0, 12.97, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 100.0, 13.38, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -210.0, 50.0, 12.38, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 100.0, 13.71, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -210.0, 50.0, 12.71, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  100.0, 14.99, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -210.0, 50.0, 13.99, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 100.0, 14.25, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -210.0, 50.0, 13.25, var_z=1, var_b=1, var_N=1)
...
dataset.save()
dataset.save_parameters("3C57-XXX.fit")
dataset.save_cont_parameters_to_file("3C57-XXX.cont")
dataset.save_fit_regions("3C57-XXX.reg")
