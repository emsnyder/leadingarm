...
dataset.set_name("UKS0242-724-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/UKS0242-724/UKS0242-724-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/UKS0242-724/UKS0242-724-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 240.0, 15.65, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  193, 120.0, 14.65, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 240.0, 15.02, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 193, 120.0, 14.02, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 240.0, 14.46, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  193, 120.0, 13.46, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  240.0, 16.08, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   193, 120.0, 15.08, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 240.0, 14.86, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   193, 120.0, 13.86, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="UKS0242-724-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("UKS0242-724-XXX.fit")
dataset.save_cont_parameters_to_file("UKS0242-724-XXX.cont")
dataset.save_fit_regions("UKS0242-724-XXX.reg")
