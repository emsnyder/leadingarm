...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/MRK304/MRK304-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/MRK304/MRK304-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 170.0, 14.03, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("SiIV",  -350, 85.0, 12.91, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  80.0, 14.7, var_z=1, var_b=1, var_N=1)
# # dataset.add_component_velocity("CII",   -380, 30.0, 13.2, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -350, 30.0, 13.2, var_z=1, var_b=1, var_N=1)

# CIV
dataset.add_component("CIV",   0., 50.0, 14.85, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -285, 10.0, 13.85, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -315, 15.0, 13.85, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   -340, 15.0, 13.85, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="MRK304-CIV.pdf")
