...
dataset.set_name("HE0153-4520-CIV")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HE0153-4520/HE0153-4520-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE0153-4520/HE0153-4520-G130M"
...
# dataset.add_component_velocity("SiIV",  180, 45.0, 12.72, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  90.0, 14.82, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   90, 45.0, 13.82, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   120, 45.0, 13.82, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   190, 45.0, 13.82, var_z=1, var_b=1, var_N=1)


# CIV
dataset.add_component("CIV",   0., 90.0, 14.25, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",  60, 10.0, 12.38, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",  130, 15.0, 12.98, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   180, 25.0, 13.25, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0153-4520-CIV.pdf")


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0153-4520-CIV.fit")
dataset.save_cont_parameters_to_file("HE0153-4520-CIV.cont")
dataset.save_fit_regions("HE0153-4520-CIV.reg")
