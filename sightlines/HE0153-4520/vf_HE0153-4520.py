...
dataset.set_name("HE0153-4520-XXX")
...
# SiII
# dataset.add_component("SiII",  0., 90.0, 13.98, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  180, 45.0, 12.98, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 90.0, 13.83, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 180, 45.0, 12.83, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("CII",   180, 45.0, 13.82, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 90.0, 14.25, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   180, 45.0, 13.25, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0153-4520-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0153-4520-XXX.fit")
dataset.save_cont_parameters_to_file("HE0153-4520-XXX.cont")
dataset.save_fit_regions("HE0153-4520-XXX.reg")
