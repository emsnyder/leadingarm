...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/MRK1014/MRK1014-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 80.0, 13.87, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  -220.0, 40.0, 12.87, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 80.0, 13.39, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", -220.0, 40.0, 12.39, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 80.0, 13.99, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  -220.0, 40.0, 12.99, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  80.0, 14.53, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   -220.0, 40.0, 13.53, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 80.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   -220.0, 40.0, -999.0, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="MRK1014-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("MRK1014-XXX.fit")
dataset.save_cont_parameters_to_file("MRK1014-XXX.cont")
dataset.save_fit_regions("MRK1014-XXX.reg")
