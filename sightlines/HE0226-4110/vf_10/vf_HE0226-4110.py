...
dataset.set_name("HE0226-4110-CIV")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/HE0226-4110/vf_10/HE0226-4110-G160M"
...
g160m_lsf = "/Users/efrazer/leadingarm/sightlines/HE0226-4110/vf_10/fuv_G160M_1600_lsf.dat"

# not using the rebinned data for the LSF test case
dataset.add_data(wl_g160m_rb, spec_g160m_rb, g160m_lsf, err=err_g160m_rb, normalized=False, nsub=3)
# dataset.add_data(wl_g160m_rb, spec_g160m_rb, 299792.458/res_g160m, err=err_g160m_rb, normalized=False)

G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE0226-4110/vf_10/HE0226-4110-G130M"
...
g130m_lsf = "/Users/efrazer/leadingarm/sightlines/HE0226-4110/vf_10/fuv_G130M_1300_lsf.dat"

# not using the rebinned data for the LSF test case
dataset.add_data(wl_g130m_rb, spec_g130m_rb, g130m_lsf, err=err_g130m_rb, normalized=False, nsub=3)
# dataset.add_data(wl_g130m_rb, spec_g130m_rb, 299792.458/res_g160m, err=err_g130m_rb, normalized=False)
...
# SiII
# dataset.add_component("SiII",  0., 30.0, 14.12, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  110, 30.5, 13.12, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  155, 30.5, 13.12, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  185, 30.5, 13.12, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("SiIII", 95, 25.5, 12.3, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 165, 25.5, 12.8, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 215, 20.5, 12.96, var_z=1, var_b=1, var_N=1)

# SiIV
# dataset.add_component("SiIV",  0., 155.0, 14.03, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIV",  195, 77.5, 13.03, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  30, 14.4, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   80, 10.0, 13.28, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   109, 10.0, 13.28, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   161, 10.5, 13.66, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   207, 25.5, 13.99, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0226-4110-CIV.pdf")


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0226-4110-CIV.fit")
dataset.save_cont_parameters_to_file("HE0226-4110-CIV.cont")
dataset.save_fit_regions("HE0226-4110-CIV.reg")
