...
dataset.set_name("HE0226-4110-XXX")
...
# SiII
# dataset.add_component("SiII",  0., 155.0, 14.12, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  195, 77.5, 13.12, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 155.0, 14.26, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiIII", 195, 77.5, 13.26, var_z=1, var_b=1, var_N=1)
...
# CII
# dataset.add_component("CII",   0,  155.0, 15.28, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   195, 77.5, 14.28, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 155.0, 14.88, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   195, 77.5, 13.88, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="HE0226-4110-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("HE0226-4110-XXX.fit")
dataset.save_cont_parameters_to_file("HE0226-4110-XXX.cont")
dataset.save_fit_regions("HE0226-4110-XXX.reg")
