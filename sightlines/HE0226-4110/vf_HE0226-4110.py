...
# CIV
dataset.add_component("CIV",   0., 30.0, 13.3, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   25, 30, 13.3, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   25, 30, 13.3, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   70, 15, 12.88, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   130, 10.0, 12.28, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   170, 15, 12.66, var_z=1, var_b=1, var_N=1)
dataset.add_component_velocity("CIV",   205, 15, 12.99, var_z=1, var_b=1, var_N=1)
