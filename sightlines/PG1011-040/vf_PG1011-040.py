...
dataset.set_name("PG1011-040-XXX")
...
G160M_filename = "/Users/efrazer/leadingarm/sightlines/PG1011-040/PG1011-040-G160M"
...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/PG1011-040/PG1011-040-G130M"
...
# SiII
# dataset.add_component("SiII",  0., 50.0, 13.44, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("SiII",  208, 25.0, 12.44, var_z=1, var_b=1, var_N=1)

# SiIII
# dataset.add_component("SiIII", 0., 50.0, 13.57, var_z=1, var_b=1, var_N=1)
...
# dataset.add_component_velocity("SiIV",  208, 25.0, 12.74, var_z=1, var_b=1, var_N=1)

# CII
# dataset.add_component("CII",   0,  50.0, 14.6, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CII",   208, 25.0, 13.6, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 50.0, 14.14, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   208, 25.0, 13.14, var_z=1, var_b=1, var_N=1)
...
dataset.plot_fit(filename="PG1011-040-XXX.pdf", max_rows=6)


# -- Save the dataset to file: taken from the dataset.name
dataset.save()
dataset.save_parameters("PG1011-040-XXX.fit")
dataset.save_cont_parameters_to_file("PG1011-040-XXX.cont")
dataset.save_fit_regions("PG1011-040-XXX.reg")
