...
G130M_filename = "/Users/efrazer/leadingarm/sightlines/HE1159-1338/HE1159-1338-G130M"
...
# dataset.add_component_velocity("CII",   205, 65.0, -999.0, var_z=1, var_b=1, var_N=1)

# CIV
# dataset.add_component("CIV",   0., 130.0, -998.0, var_z=1, var_b=1, var_N=1)
# dataset.add_component_velocity("CIV",   205, 65.0, -999.0, var_z=1, var_b=1, var_N=1)
